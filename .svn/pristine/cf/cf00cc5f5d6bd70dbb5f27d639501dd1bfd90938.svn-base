...
public class ShoesInfoController extends BaseController {
    ...
    public R getShoesList(@ApiIgnore @LoginUser BaseUserEntity loginUser,
        ...
        try {
            ...
            List<Map<String, Object>> shoesList = shoesInfoService.getShoesList(periodSeq, loginUser.getSaleType(), categorySeqList, shoesSeqList, goodNameId, orderBy, orderDir, start, num,meetingSeq,year,type,status,loginUser.getSeq());
