...
<body>
	...
	<div class="main_content">
		...
		<div class="content_right">
			<table cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td style="background-color:#FAFBFD;">
						<iframe name="mainFrame" id="mainFrame" frameborder="0" src="default" style="width:100%;height:100%;min-width:1024px;"></iframe>
					</td>
			...
			<div class="sys_bottom" style="width:100%;text-align: center;height:27px;line-height:27px;">Copyright &copy; 2017 xxxxx有限公司&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://www.miibeian.gov.cn/"  ><font color="#282828">蒙ICP备10000583号-6</font></a>
			</div>
		</div>
	</div>
