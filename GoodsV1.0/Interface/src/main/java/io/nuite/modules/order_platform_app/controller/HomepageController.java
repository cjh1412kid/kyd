...
@Api(tags = "订货平台 - 首页", description = "轮播图 + 爆款 + 新品 + 公告")
public class HomepageController extends BaseController {
    ...
    public R getHotsaleList(@ApiIgnore @LoginUser BaseUserEntity loginUser,
    	...
    	try {
			...
			List<Map<String,Object>> hotsaleShoeslist = homepageService.getHotsaleShoesList(periodSeqList, loginUser.getSaleType(), start, num);
    ...
    public R getNewestList(@ApiIgnore @LoginUser BaseUserEntity loginUser,
    	...
    	try {
			...
			List<Map<String,Object>> newestShoesList = homepageService.getNewestShoesList(periodSeqList, loginUser.getSaleType(), start, num);
