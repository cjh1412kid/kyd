  ...
  methods: {
    ...
    saveOrUpdate: function () {
      ...
      vm.factoryDetail.menuIdList = menuIdList;
        ...
        if(vm.factoryDetail.version) {
            vm.factoryDetail.version = 1;
        }else {
            vm.factoryDetail.version = 0;
        }
...
function lineEdit(seq) {
  $.get(baseURL + "system/factory/info?seq=" + seq, function (r) {
    ...
    vm.factoryDetail = r.factory;
      ...
      if(r.factory.version === 0) {
          vm.factoryDetail.version = false;
      }else if (r.factory.version === 1) {
          vm.factoryDetail.version = true;
      }
    if (r.factory.olsSeq) {
