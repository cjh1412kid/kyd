...
public interface OrderService extends IService<OrderEntity> {
	...
	List<Object> getOrderSeqByCompanySeqWithinTime(Integer companySeq, Date startTime, Date endTime);
     ...
     * @throws Exception
     */
    BigDecimal getTotalMoney(Integer orderSeq) throws Exception;
}
