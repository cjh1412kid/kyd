...
public class MeetingGoodsPermissionController extends BaseController {
    ...
    public R getAllMeetingDevice(@ApiIgnore @LoginUser BaseUserEntity baseUserEntity) {
    	try {
    		
    		List<MeetingDeviceEntity> bleList = meetingDeviceService.getAllMeetingDevice(0,baseUserEntity.getCompanySeq());
    		List<MeetingDeviceEntity> phoneList = meetingDeviceService.getAllMeetingDevice(1,baseUserEntity.getCompanySeq());
